class OriCode < Formula
  ...
  url "https://github.com/cassianwolfe/ori-code/releases/download/v0.9.40/ori-code-0.9.40.tar.gz"
  sha256 "f1722c16fa7e02396a45ea5101f22e6ad5c32c6ed8ec5b6412ad5b046888f94f"
  license "MIT"
