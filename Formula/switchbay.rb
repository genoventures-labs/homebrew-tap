class Switchbay < Formula
  ...
  url "https://github.com/genoventures-labs/Switchbay/releases/download/v1.6.957/switchbay-1.6.957.tar.gz"
  sha256 "dc55fa1e9519396fa6868f266fc86186b517e6e3ff05f85679622f591105422a"
  license "MIT"
